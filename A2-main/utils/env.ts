...
const CLIENT_ID = "fa26641d38544a30beccde2c49b1ddf5"; // TODO: Replace this with your own client ID
const REDIRECT_URI = "exp://10.27.118.245:8081"; // TODO: Replace this with your own redirect URI
...
const ENV = {
  ...
  SPOTIFY_API: {
    ...
    ALBUM_TRACK_API_GETTER: (albumId: string) => `https://api.spotify.com/v1/albums/${albumId}/tracks` + albumId,
  },
};
